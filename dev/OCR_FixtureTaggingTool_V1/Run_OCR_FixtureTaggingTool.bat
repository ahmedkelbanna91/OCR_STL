...
echo [93m========================="OCR_FixtureTaggingTool V1"==========================[0m
...
COPY /Y ".\model\fixture\dummy.stl" ".\model\input\!ID!.stl"  >nul
CALL OCR_STL.exe "!ID!" "-1.0"
CALL PROCESS_OCR_STL.exe "!ID!.stl"
DEL ".\model\input\!ID!.stl" >nul
IF exist ".\model\output\!ID!.stl" (
    MOVE /Y ".\model\output\!ID!.stl" "%output_path%\!ID!_F.stl" >nul
    SET /a doneCNT+=1
